...
void heartbeatTaskFunc(void *) {
    ...
    while (1) {
        ...
        //printf("Gx: %f7.3 Gy: %f7.3 Gz: %f7.3 Ax: %f7.3 Ay: %f7.3 Az: %f7.3\n", imuRaw.Gx, imuRaw.Gy, imuRaw.Gz, imuRaw.Ax, imuRaw.Ay, imuRaw.Az);
        printf("pitch: %f7.3 Vpitch: %f7.3 roll: %f7.3 Vroll: %f7.3 Vz:\n", imuFiltered.pitch, imuFiltered.Vpitch, imuFiltered.roll, imuFiltered.Vroll, imuFiltered.Vz);
        // printf(
